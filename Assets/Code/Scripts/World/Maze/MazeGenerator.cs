...
public class MazeGenerator : MonoBehaviour
{
	...
	[Header("Maze")]
	[Range(5, 40)]
	[SerializeField] private short mazeSize = 5;
	...
	private readonly List<Dirs> randomDir = new List<Dirs> { Dirs.North, Dirs.South, Dirs.East, Dirs.West };
	...
	private readonly List<Dirs> dirs = new List<Dirs> { Dirs.North, Dirs.South, Dirs.East, Dirs.West };
	...
	private List<GameObject> GenerateEnemies()
	{
		...
		for (int i = 0; i < GameManager.instance.GetPlayerLevel(); i++)
		{
			GameObject enemyToSpawn = null;

			enemyToSpawn = Utils.rng.Next(100) switch
			{
				<= 50 => zombiePrefab,
				<= 70 => spiderPrefab,
				<= 90 => crabPrefab,
